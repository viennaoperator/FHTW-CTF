...
$(function(){
    $('#challenge-form').on('submit', function(e){
        ...
        $.ajax({
            url: '/addChallenge', //this is the submit URL
            type: 'GET', //or POST
...
$("#stop").click(function () {
  ...
  for (var id in ids){
    $.ajax({
      url: '/stopChallengeContainer/' + ids[id],
      success: function(result){
